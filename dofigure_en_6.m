...
u_A_gap_fft = abs(u_A_gap_fft/n_u_A_gap);
% y_fft = y_fft(1:(n+1)/2);
...
T_A = 0:4/f0/n_u_A_rf:(4/f0 - 1/f0/n_u_A_rf);
...
%%
figure(1)
plot(f,P_u_A_rf_smooth,'--','LineWidth',0.8)
...
legend('RF-SVPWM','the second SNS method')
...
set(gca,'FontSize',12,'FontName','Arial');
hold on
plot(f,P_u_A_rf_smooth,'-.','LineWidth',0.8,'Color','b')
hold on
plot(f,P_u_A_gap_smooth,'Color','r','LineWidth',0.3)
legend('CSVPWM','RF-SVPWM','the second SNS method')
